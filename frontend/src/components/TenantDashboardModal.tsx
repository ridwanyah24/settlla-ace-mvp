      ...
      >
        ...
        <div className="sticky top-0 z-20 flex min-w-0 items-center justify-between gap-2 border-b border-slate-200 bg-white/95 px-4 sm:px-6 py-3.5 sm:py-4 backdrop-blur-md">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-md shadow-blue-500/25">
              <User className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="text-base sm:text-lg font-black text-slate-900">Tenant Dashboard</h2>
                <span className="hidden sm:inline rounded-full bg-blue-50 text-blue-700 text-[10px] font-bold px-2 py-0.5 border border-blue-200">
                  Verified Tenant
                </span>
              </div>
