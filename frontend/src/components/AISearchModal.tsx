...
export const AISearchModal: React.FC<AISearchModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 lg:p-6">
      ...
      {/* Modal Card */}
      <div className="relative z-10 flex flex-col w-full max-w-4xl max-h-[92vh] sm:max-h-[88vh] rounded-3xl bg-white shadow-2xl shadow-blue-950/30 border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header Strip */}
        <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white px-5 sm:px-7 py-4 flex items-center justify-between border-b border-blue-800/60">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-500 to-indigo-400 text-white shadow-md shadow-blue-500/30">
              <Sparkles className="h-5 w-5 animate-pulse" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-lg font-black tracking-tight text-white">
                  Settlla AI Natural Search
                </h2>
                <span className="rounded-full bg-blue-500/30 border border-blue-400/40 px-2 py-0.5 text-[10px] font-black uppercase tracking-wider text-blue-200">
                  Kaduna Verified
                </span>
              </div>
              <p className="text-xs text-blue-200/80 font-medium">
                Ask in plain English: budget, neighborhood, prepaid meter, security, or commute.
              </p>
            </div>
          </div>
          <button
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-4 flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100">
                        <button
                          ...
                          className="flex-1 sm:flex-initial rounded-xl border border-slate-300 bg-white hover:bg-slate-50 px-3.5 py-2 text-xs font-bold text-slate-700 transition-colors cursor-pointer"
                        >
                          View Full Details
                        </button>
                        <button
                          ...
                          className="flex-1 sm:flex-initial rounded-xl bg-slate-100 hover:bg-slate-200 px-3.5 py-2 text-xs font-bold text-slate-800 transition-colors cursor-pointer"
                        >
                          Book Walkthrough
                        </button>
                        <button
                          ...
                          onClick={() => {
                            onClose();
                            onDirectApply(listing);
                          }}
                          className="flex-1 sm:flex-initial rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2 text-xs font-bold text-white shadow-sm shadow-blue-500/20 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                        >
