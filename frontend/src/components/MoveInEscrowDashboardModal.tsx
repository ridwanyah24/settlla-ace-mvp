      ...
      <div className="relative z-10 w-full max-w-4xl max-h-[92vh] bg-white rounded-3xl border border-slate-200 shadow-2xl flex flex-col overflow-hidden text-slate-900 animate-scale-up">
        ...
        <div className="bg-gradient-to-r from-[#0B1528] via-slate-900 to-emerald-950 px-4 sm:px-8 py-4 sm:py-5 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 border-b border-slate-800">
          <div className="w-full sm:w-auto">
            <div className="flex flex-wrap items-center justify-between sm:justify-start gap-2 mb-1.5">
              ...
              <button
                type="button"
                onClick={onClose}
                className="sm:hidden flex h-8 w-8 items-center justify-center rounded-xl bg-white/10 text-white hover:bg-white/20 transition-colors cursor-pointer"
        ...
        {/* Navigation Tab Bar */}
        <div className="flex border-b border-slate-200 bg-slate-50 px-4 sm:px-8 py-2 text-xs font-bold gap-2 overflow-x-auto no-scrollbar">
          <button
            type="button"
            onClick={() => setActiveTab("overview")}
            className={`px-3 sm:px-4 py-2 rounded-xl transition-colors cursor-pointer flex items-center gap-1.5 whitespace-nowrap ${
          ...
          >
            ...
            <span>Report Problem (Freeze)</span>
              ...
              {escrow.escrow_status === "holding" && (
                <div className="rounded-3xl border-2 border-blue-200 bg-gradient-to-r from-[#0B1528] to-slate-900 p-6 sm:p-8 text-white shadow-md space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
                    ...
                    <div className="rounded-2xl bg-white/10 border border-white/15 p-4 text-center w-full sm:w-auto min-w-0 sm:min-w-[200px]">
