  ...
  return (
    <div className="settlla-overlay">
      ...
      <div className="settlla-dialog settlla-dialog--xl">
        {/* Header */}
        <div className="flex min-w-0 items-center justify-between gap-2 border-b border-slate-100 px-4 sm:px-8 py-4 sm:py-5 bg-slate-900 text-white">
        ...
        {/* Content Body */}
        <div className="flex-1 min-h-0 overflow-y-auto p-4 sm:p-8 bg-[#F8FAFC] space-y-6">
          {/* Quick Metrics */}
