        ...
        <div className="p-6 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full rounded-xl bg-blue-600 hover:bg-blue-700 py-3 text-xs sm:text-sm font-bold text-white transition-all shadow-md shadow-blue-500/25 cursor-pointer"
              >
                {mode === "signin" ? `Sign In as ${role === "tenant" ? "Tenant" : "Agent"}` : "Create Account & Go to Dashboard"}
              </button>
            </div>
          </form>
        </div>
